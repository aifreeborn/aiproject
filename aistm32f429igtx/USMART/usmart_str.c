...
/*
********************************************************************************
*    Function: usmart_strcmp
* Description: 对比字符串str1和str2
*       Input: str1 - 字符串1指针
*              str2 - 字符串2指针
*      Output: None
*      Return: 返回值:0，相等;1，不相等;
*      Others: None
********************************************************************************
*/
...
/*
********************************************************************************
*    Function: usmart_strcopy
* Description: 把str1的内容copy到str2
*       Input: str1 - 字符串1指针
*              str2 - 字符串2指针	
*      Output: None
*      Return: void
...
/*
********************************************************************************
*    Function: usmart_str2num
* Description: 把字符串转为数字,支持16进制转换,但是16进制字母必须是大写的,
*              且格式为以0X开头的.
*              支持负数 
*       Input: str - 数字字符串指针
*              res - 转换完的结果存放地址.
*      Output: None
*      Return: 0，成功转换完成.其他,错误代码.
...
/*
********************************************************************************
*    Function: usmart_search_nextc
* Description: 获取下一个字符（当中间有很多空格的时候，此函数直接忽略空格，
*              找到空格之后的第一个字符）
*       Input:     str - 字符串指针
*      Output: None
*      Return: 下一个字符
...
/*
********************************************************************************
*    Function: usmart_get_fname
* Description: 从str中得到函数名
*       Input:   str - 源字符串指针
*              fname - 获取到的函数名字指针
*               pnum - 函数的参数个数
    ...
    while (1) {
        ...
        if (fover == 0) {                         // 函数名还没接收完
            ...
            if (*strtemp == ',') {
                ...
                // 当第一个参数来时,为了避免统计void类型的参数,必须做判断.
                if (pcnt == 0 && fplcnt < 5) {
...
/*
********************************************************************************
*    Function: usmart_get_aparm
* Description: 从str中得到一个函数的参数
*       Input:   str - 源字符串指针
*              fparm - 参数字符串指针
*              ptype - 参数类型 0，数字;1，字符串;0XFF，参数错误
*      Output: None
*      Return: 0,已经无参数了;其他,下一个参数的偏移量.
*      Others: None
********************************************************************************
*/
...
/*
********************************************************************************
*    Function: usmart_get_parmpos
* Description: 得到指定参数的起始地址
*       Input: num - 第num个参数,范围0~9.
*      Output: None
*      Return: 该参数的起始地址
*      Others: None
********************************************************************************
...
/*
********************************************************************************
*    Function: usmart_get_fparam
* Description: 从str中得到函数参数
*       Input:  str - 源字符串;
